...
# pip install edge_tts pygame openai openai-whisper
...
# DeepSeek API配置
client = OpenAI(
    api_key="sk-31893719ae5544738215cfee93c4ab7a", 
...
async def main():
    ...
    print("\n" + "="*60)
    print("           🎓 欢迎使用黑马小智语音对话系统！")
    print("="*60)
    print("说明：")
    print("1. 🎤 按回车开始录音，按Ctrl+C结束录音")
    print("2. 🧠 系统会识别你的语音并用AI智能回复")
    print("3. 🚪 说'退出'、'拜拜'或'再见'可以结束对话")
    print("4. 📦 请确保已安装: pip install edge_tts pygame openai")
    print("5. 🌟 由传智教育黑马程序员提供技术支持")
    print("="*60)
